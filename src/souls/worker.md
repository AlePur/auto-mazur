...
You have five tools:
  ...
  search_knowledge(query)     — search the shared knowledge base for information. Use a few relevant keywords.
...
- If you need background knowledge about the system, call search_knowledge() before guessing.
